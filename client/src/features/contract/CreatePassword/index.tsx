...
export default function CreatePassword({ onSubmit, passwordNameRef, passwordRef }: ICreatePasswordProps) {
	const [isPasswordVisible, setIsPasswordVisible] = useState<boolean>(false)

	return (
		<form onSubmit={onSubmit} className='CreatePasswordForm w-1/2 h-1/2 flex flex-col items-center justify-start'>
			...
			<div className='inputContainer w-full flex flex-col items-center justify-between my-4 py-3'>
				...
				<div className='w-full flex items-center justify-between relative'>
					<input ref={passwordRef} type={isPasswordVisible ? 'text' : 'password'} name='password' placeholder='Enter a password' className='w-full h-full rounded-md p-4 text-slate-900' />
					{isPasswordVisible ? (
