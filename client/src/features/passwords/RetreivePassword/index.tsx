...
export default function RetreivePassword({ onSubmit, encryptionIdRef }: IRetreivePasswordProps) {
	return (
		<form
			onSubmit={onSubmit}
			className='HashIdForm w-1/2 h-auto flex flex-col items-center justify-between'
		>
			...
			<button
				type='submit'
				className='w-1/3  py-3 mt-12 rounded-md bg-sky-500 text-slate-100 cursor-pointer'
